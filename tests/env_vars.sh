...
export admin_password=random_string
export conn_string=random_string
export python=/path/to/your/python
export SOLUTIONS_API_USER=random_string
...
export base_url=http://localhost:9707
export designer_questionnaire_id=9d3ad06999aa4d6a8edaad12c722a60f
